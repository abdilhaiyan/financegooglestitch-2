 ...
 * Event handlers, navigation, modals, dark mode, init.
 */
...
const App = (() => {
  ...
  async function fetchSheetData() {
    ...
    try {
      ...
      Render.syncBadge('offline', 'Offline / Error');
  ...
  function renderView(viewId) {
    switch (viewId) {
      ...
      case 'view-settings':      break; // static view
    }
  }
  ...
  async function submitTransaction(e) {
    ...
    try {
      if (editingTransactionID) {
        ...
        btn.textContent = 'POST TO GOOGLE SHEET';
  ...
  function editTransaction(transactionID) {
    ...
    // Switch to payments view (where the form lives)
  ...
  function editRecurring(billID) {
    ...
    if (!bill) {
      Render.toast('Bill not found.', 'error');
      return;
    }
  ...
  function editGoal(goalName) {
    ...
    if (!goal) {
      Render.toast('Goal not found.', 'error');
      return;
    }
